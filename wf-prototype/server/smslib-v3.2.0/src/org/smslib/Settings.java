...
public class Settings
{
	 ...
	 */
	public int WATCHDOG_INTERVAL = 5000;
	...
	Settings()
	{
		...
		if (System.getProperty("smsib.at.cnmiwait") != null) AT_WAIT_CNMI = Integer.parseInt(System.getProperty("smsib.at.cnmiwait"));
		if (System.getProperty("smsib.watchdog") != null) WATCHDOG_INTERVAL = Integer.parseInt(System.getProperty("smsib.watchdog"));
	}
}
