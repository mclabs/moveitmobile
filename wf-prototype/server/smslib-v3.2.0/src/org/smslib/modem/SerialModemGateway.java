...
public class SerialModemGateway extends ModemGateway
{
	 ...
	 */
	public SerialModemGateway(String id, String comPort, int baudRate, String manufacturer, String model, Service srv)
	{
		super(ModemTypes.SERIAL, id, comPort, baudRate, manufacturer, model, srv);
	}
}
