...
public class IPModemGateway extends ModemGateway
{
	 ...
	 */
	public IPModemGateway(String id, String ipName, int ipPort, String manufacturer, String model, Service srv)
	{
		super(ModemTypes.IP, id, ipName, ipPort, manufacturer, model, srv);
	}
}
